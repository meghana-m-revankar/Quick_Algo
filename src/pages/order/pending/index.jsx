...
import usePendingOrder from "./pending";
...
const PendingOrder = () => {
  ...
  return (
    <div className="active_order_page pending_page">
            ...
            {isLoading ? (
              ...
              <tr className="text-center">
                <td colSpan={"100%"} className="text-center">
                  ...
                  <p className="fs-16">
                    Please note that pending orders will be executed based on
                    the prevailing bid and ask prices, not the last traded price
                    (LTP)! May your trades be profitable and your mindset always
                    positive!
                  </p>
                </td>
              </tr>
