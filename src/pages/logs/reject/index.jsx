...
import useRejectedLogs from "./reject";
...
const RejectedLogs = () => {
  ...
  const symbolRejectedLogs = useSymbolDetails(rejectedLogsList, "order");
          ...
          <tbody>
            {isLoading ? (
              ...
              paginatedData?.map((val, key) => {
                const ao = symbolRejectedLogs[val?.identifier];
